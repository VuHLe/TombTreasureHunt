...
#include "OldPrison/Grabber.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeGrabber() {}
// Cross Module References
	OLDPRISON_API UClass* Z_Construct_UClass_UGrabber_NoRegister();
	OLDPRISON_API UClass* Z_Construct_UClass_UGrabber();
...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UGrabber_Grab_Statics::Function_MetaDataParams[] = {
		{ "Comment", "// create a function that can be use and call in EU editor\n" },
		{ "ModuleRelativePath", "Grabber.h" },
		{ "ToolTip", "create a function that can be use and call in EU editor" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UGrabber_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UGrabber_Grab, "Grab" }, // 590257730
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UGrabber_Statics::NewProp_HoldDistance_MetaData[] = {
		{ "Category", "Grabber" },
		{ "Comment", "// radius of the zone where player can interact with actors\n" },
		{ "ModuleRelativePath", "Grabber.h" },
		{ "ToolTip", "radius of the zone where player can interact with actors" },
	};
#endif
	...
	template<> OLDPRISON_API UClass* StaticClass<UGrabber>()
	{
		return UGrabber::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UGrabber);
	struct Z_CompiledInDeferFile_FID_OldPrison_Source_OldPrison_Grabber_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_OldPrison_Source_OldPrison_Grabber_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGrabber, UGrabber::StaticClass, TEXT("UGrabber"), &Z_Registration_Info_UClass_UGrabber, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGrabber), 2132254974U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_OldPrison_Source_OldPrison_Grabber_h_3500494944(TEXT("/Script/OldPrison"),
		Z_CompiledInDeferFile_FID_OldPrison_Source_OldPrison_Grabber_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_OldPrison_Source_OldPrison_Grabber_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
